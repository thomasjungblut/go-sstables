...
func file___examples_proto_mutation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file___examples_proto_mutation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file___examples_proto_mutation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file___examples_proto_mutation_proto_msgTypes[2].Exporter = func(v any, i int) any {
