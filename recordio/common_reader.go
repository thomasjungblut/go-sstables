...
func readRecordHeaderV4(r io.ByteReader, recordHeaderPooled []byte) (payloadSizeUncompressed uint64, payloadSizeCompressed uint64, recordNilBool bool, err error) {
	reader := &checksumByteReader{
		ByteReader: r,
		bytes:      recordHeaderPooled[:],
	}
